      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-400 to-blue-700 hover:bg-slate-200 text-white"
            >
              Hire Me
            </Link>
            <Link
        ...
        >
          <div className="rounded-full bg-[#181818] z-2 w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            ...
            <Image
              src="/images/4.png"
              alt="hero image"
              className="absolute z-2 rounded-full transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
              width={300}
              height={300}
            />
          </div>
